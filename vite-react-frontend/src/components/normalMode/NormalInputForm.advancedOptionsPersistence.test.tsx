...
describe('NormalInputForm advanced options persistence', () => {
  it('persists all advanced fields to localStorage (key contract)', async () => {
    ...
    render(<SimulationForm mode="advanced" advancedFeatureFlags={{ inflation: true, fee: true, exemptions: true, returnModel: true }} />);
    ...
    fireEvent.change(screen.getByLabelText(/RNG seed/i), { target: { value: '123' } });
